...
// Validate input
$required_fields = ['aadhaar', 'officerName', 'middleName', 'surname', 'fatherName', 'motherName', 'gender', 'dob', 'mobileNumber', 'password', 'confirmPassword'];
...
$stmt = $conn->prepare("INSERT INTO officer_register 
